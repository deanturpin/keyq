//
//  keyqExtensionAUProcessHelper.hpp
//  keyqExtension
//
...
#include <vector>
#include "keyqExtensionDSPKernel.hpp"
#include "keyqExtensionBufferedAudioBus.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(keyqExtensionDSPKernel& kernel, BufferedInputBus& bufferedInputBus)
    : mKernel{kernel},
...
private:
    keyqExtensionDSPKernel& mKernel;
